...
class GoogleDriveHelper:
    ...
    def drive_list(self, fileName):
        ...
        for parent_id in DRIVE_ID :
            ...
            if response:
                if add_title_msg == True:
                    msg = f'<h4>Search Results for : {fileName}</h4><br><a href="https://t.me/NJTorrent">@NJTorrent</a><br>' \
                          f'<a href="https://groups.google.com/d/forum/njteamdrive">Join Our TeamDrive</a><br><br>'
                    add_title_msg = False
        ...
        for content in self.telegraph_content :
            self.path.append(telegra_ph.create_page(title = 'NJTorrent',
